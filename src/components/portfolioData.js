...
import trigis from "../assets/images/trigis.png";

export const portfolioItems = [
  {
    id: 1,
    category: "Web Development",
    title: "Trigis Consult",
    description:
      "A full-stack consultancy website where users explore services and administrators manage service content via a custom dashboard.",
    image: trigis,
    tags: ["React", "Tailwind", "Node", "Express", "MongoDB"],
    type: "Development",
    liveLink: "https://trigisconsult.netlify.app/",
